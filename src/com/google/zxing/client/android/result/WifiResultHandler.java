...
public final class WifiResultHandler extends ResultHandler {
	...
	private final BarCodeCaptureActivity parent;

	public WifiResultHandler(BarCodeCaptureActivity activity,
			ParsedResult result) {
	...
	public void handleButtonPress(int index) {
		...
		if (index == 0) {
			...
			WifiConfigManager.configure(wifiManager, ssid, password,
					networkType);
