...
public final class WifiConfigManager {
		...
		Runnable configureRunnable = new Runnable() {
			...
			public void run() {
				...
				NetworkType networkType = NetworkType
						.forIntentValue(networkTypeString);
	...
	private static void changeNetworkWEP(WifiManager wifiManager, String ssid,
			String password) {
	...
	private static void changeNetworkWPA(WifiManager wifiManager, String ssid,
			String password) {
		WifiConfiguration config = changeNetworkCommon(ssid);
