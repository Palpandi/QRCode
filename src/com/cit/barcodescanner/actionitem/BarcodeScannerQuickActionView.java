...
public class BarcodeScannerQuickActionView extends BarcodeScannerPopupWindows implements
		OnDismissListener {
	 ...
	 *            Context
	 */
	public BarcodeScannerQuickActionView(Context context) {
	 ...
	 */
	public BarcodeScannerQuickActionView(Context context, int orientation) {
		super(context);
			...
			public void onClick(View v) {
				if (mItemClickListener != null) {
					mItemClickListener.onItemClick(
							BarcodeScannerQuickActionView.this, pos, actionId);
				}
	...
	public void setOnDismissListener(
			BarcodeScannerQuickActionView.OnDismissListener listener) {
	...
	public interface OnActionItemClickListener {
		public abstract void onItemClick(BarcodeScannerQuickActionView source,
