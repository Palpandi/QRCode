package com.cit.barcodescanner.actionitem;
...
import com.cit.barcodescanner.BarcodeScannerVariable;
 ...
 * 
 */
public class BarcodeScannerQuickAction extends BarcodeScannerPopupWindows implements
		OnDismissListener {
	...
	private List<BarcodeScannerActionItem> actionItems = new ArrayList<BarcodeScannerActionItem>();
	 ...
	 *            Context
	 */
	public BarcodeScannerQuickAction(Context context) {
		this(context, VERTICAL);
		
		font = Typeface.createFromAsset(context.getAssets(),
				BarcodeScannerVariable.FONT_NAME);
	 ...
	 */
	public BarcodeScannerQuickAction(Context context, int orientation) {
		super(context);
	 ...
	 */
	public BarcodeScannerActionItem getActionItem(int index) {
	 ...
	 * 
	 * @param action
	 *            {@link FoodAppActionItem}
	 */
	public void addActionItem(BarcodeScannerActionItem action) {
		...
		Button text = (Button) container.findViewById(R.id.tv_title);
		...
		text.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mItemClickListener != null) {
					mItemClickListener.onItemClick(BarcodeScannerQuickAction.this,
							pos, actionId);
				}
	...
	public void setOnDismissListener(
			BarcodeScannerQuickAction.OnDismissListener listener) {
	...
	public interface OnActionItemClickListener {
		public abstract void onItemClick(BarcodeScannerQuickAction source, int pos,
				int actionId);
	}
